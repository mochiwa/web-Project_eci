...
class ACLMiddlewareTest extends TestCase{
    ...
    function test_process_shouldSendHandle_whenRequestNotContainRoute()
    {
    ...
    function test_process_shouldSetCurrentRoleToVisitor_whenSessionDoesContainAnyUser()
    {
    ...
    function test_process_shouldSetCurrentRoleToUser_whenSessionDoesContainAnUser()
    {
        $request=$request=$this->requestWithRoute();
    ...
    function test_process_shouldTestRoleAdminForCurrentRole_whenRouteNameContainAdmin()
    {
