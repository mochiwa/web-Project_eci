...
class ArticleModule extends AbstractModule {
    ...
    public function __construct(IRouter $router, IViewBuilder $viewBuilder) {
        ...
        $router->map('GET', '/parking/admin/[a:create]', AdminArticleController::class, 'parking.admin.create');
        ...
        $router->map('POST', '/parking/admin/edit-[a:id]', AdminArticleController::class, 'parking.admin.edit.process');
